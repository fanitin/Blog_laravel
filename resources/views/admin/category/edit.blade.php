  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Category "{{$category->name}}" editing</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <form action="{{route("admin.category.update", $category->id)}}" method="POST" autocomplete="off">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="id_name" name="name" placeholder="Enter the name of category" value="{{$category->name}}">
                  @error('name')
